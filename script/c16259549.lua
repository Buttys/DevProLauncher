...
function c16259549.initial_effect(c)
  --xyz summon
	...
	e3:SetCost(c16259549.cost)
	e3:SetCondition(c16259549.condition)
	e3:SetTarget(c16259549.target)
	e3:SetOperation(c16259549.operation)
	c:RegisterEffect(e3)
end
