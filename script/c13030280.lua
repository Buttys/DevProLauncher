...
function c13030280.initial_effect(c)
	...
	e1:SetCondition(c13030280.damcon)
	e1:SetCost(c13030280.cost)
	e1:SetTarget(c13030280.damtg)
	e1:SetOperation(c13030280.damop)
	c:RegisterEffect(e1)
	--
	...
	e2:SetCountLimit(1)
	e2:SetValue(c13030280.valcon)
	c:RegisterEffect(e2)
end
function c13030280.cost(e,tp,eg,ep,ev,re,r,rp,chk)
