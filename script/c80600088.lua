...
function c80600088.initial_effect(c)
	...
	--special
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(80600088,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_GRAVE)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetCondition(c80600088.spcon)
	e2:SetCost(c80600088.spcost)
	e2:SetTarget(c80600088.sptg)
	e2:SetOperation(c80600088.spop)
	c:RegisterEffect(e2)
end
...
function c80600088.filter1(c,e,tp)
	return c:IsFaceup() and c:IsSetCard(0x7a) and 
