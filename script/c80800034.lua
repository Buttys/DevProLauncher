...
function c?80800034.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(80800034,1))
...
function c?80800034.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if sel==1 then
		ac=Duel.SelectOption(tp,aux.Stringid(80800034,2))
	elseif sel==2 then
		ac=Duel.SelectOption(tp,aux.Stringid(80800034,3))+1
	elseif sel==4 then
		ac=Duel.SelectOption(tp,aux.Stringid(80800034,4))+2
	elseif sel==3 then
		if gc==1 then ac=Duel.SelectOption(tp,aux.Stringid(80800034,2),aux.Stringid(80800034,3))
		else
		ac=Duel.SelectOption(tp,aux.Stringid(80800034,2),aux.Stringid(80800034,3),aux.Stringid(80800034,5)) end
		if ac==2 then ac=3 end
	elseif sel==5 then
		if gc==1 then ac=Duel.SelectOption(tp,aux.Stringid(80800034,2),aux.Stringid(80800034,4)) 
		else
		ac=Duel.SelectOption(tp,aux.Stringid(80800034,2),aux.Stringid(80800034,4),aux.Stringid(80800034,5)) end
		if ac==1 then ac=2 end
		if ac==2 then ac=4 end
	elseif sel==6 then
		if gc==1 then ac=Duel.SelectOption(tp,aux.Stringid(80800034,3),aux.Stringid(80800034,4))+1 
		else
		ac=Duel.SelectOption(tp,aux.Stringid(80800034,3),aux.Stringid(80800034,4),aux.Stringid(80800034,5))+1 end
		if ac==3 then ac=5 end
	elseif sel==7 then
		if gc==1 then ac=Duel.SelectOption(tp,aux.Stringid(80800034,2),aux.Stringid(80800034,3),aux.Stringid(80800034,4))
		elseif gc==2 then 
		ac=Duel.SelectOption(tp,aux.Stringid(80800034,2),aux.Stringid(80800034,3),aux.Stringid(80800034,4),aux.Stringid(80800034,6),aux.Stringid(80800034,7),aux.Stringid(80800034,8))
		else
		ac=Duel.SelectOption(tp,aux.Stringid(80800034,2),aux.Stringid(80800034,3),aux.Stringid(80800034,4),aux.Stringid(80800034,6),aux.Stringid(80800034,7),aux.Stringid(80800034,8),aux.Stringid(80800034,9))
		end
	end
	e:SetLabel(ac)
end
