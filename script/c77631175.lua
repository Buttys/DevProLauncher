...
function c77631175.initial_effect(c)
	...
	e1:SetOperation(c77631175.repop)
	c:RegisterEffect(e1)
	--atkup & damage
	...
	e2:SetCode(77631175)
	e2:SetTarget(c77631175.atktg)
	e2:SetOperation(c77631175.atkop)
	c:RegisterEffect(e2)
end
...
function c77631175.repop(e,tp,eg,ep,ev,re,r,rp)
	Duel.RaiseSingleEvent(e:GetHandler(),77631175,e,0,0,tp,nil)
end
function c77631175.atktg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetTargetPlayer(1-tp)
	Duel.SetTargetParam(500)
	Duel.SetOperationInfo(0,CATEGORY_DAMAGE,nil,0,1-tp,500)
end
function c77631175.atkop(e,tp,eg,ep,ev,re,r,rp)
