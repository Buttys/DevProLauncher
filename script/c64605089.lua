...
function c64605089.initial_effect(c)
	...
	e1:SetCondition(c64605089.spcon)
	e1:SetTarget(c64605089.sptg)
	e1:SetOperation(c64605089.spop)
	c:RegisterEffect(e1)
	--effect gain
...
function c64605089.spcon(e,tp,eg,ep,ev,re,r,rp)
	local at=Duel.GetAttacker()
	return at:GetControler()~=tp and Duel.GetAttackTarget()==nil
end
function c64605089.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c64605089.spop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
