...
function c15914410.initial_effect(c)
	...
	e1:SetCountLimit(1)
	e1:SetCost(c15914410.cost)
	e1:SetTarget(c15914410.postg)
	e1:SetOperation(c15914410.operation)
	c:RegisterEffect(e1)
end
function c15914410.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c15914410.operation(e,tp,eg,ep,ev,re,r,rp)
