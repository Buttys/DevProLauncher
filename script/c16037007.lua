...
function c16037007.initial_effect(c)
	...
	e1:SetCondition(c16037007.negcon)
	e1:SetCost(c16037007.negcost)
	e1:SetTarget(c16037007.negtg)
	e1:SetOperation(c16037007.negop)
	c:RegisterEffect(e1)
end
function c16037007.negcon(e,tp,eg,ep,ev,re,r,rp)
...
function c16037007.negcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():CheckRemoveOverlayCard(tp,1,REASON_COST) end
	e:GetHandler():RemoveOverlayCard(tp,1,1,REASON_COST)
end
function c16037007.negtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c16037007.negop(e,tp,eg,ep,ev,re,r,rp)
