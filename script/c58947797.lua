...
function c58947797.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c58947797.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c58947797.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:GetLabel()==0 then g=Duel.SelectMatchingCard(1-tp,c58947797.tgfilter,1-tp,LOCATION_DECK,0,1,1,nil,TYPE_MONSTER)
	elseif e:GetLabel()==1 then g=Duel.SelectMatchingCard(1-tp,c58947797.tgfilter,1-tp,LOCATION_DECK,0,1,1,nil,TYPE_SPELL)
	else g=Duel.SelectMatchingCard(1-tp,c58947797.tgfilter,1-tp,LOCATION_DECK,0,1,1,nil,TYPE_TRAP) end
...
function c58947797.ftarget(e,c)
