...
function c80764541.initial_effect(c)
	...
	e1:SetLabel(0)
	e1:SetCost(c80764541.cost)
	e1:SetTarget(c80764541.target)
	e1:SetOperation(c80764541.operation)
	c:RegisterEffect(e1)
end
function c80764541.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c80764541.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c80764541.operation(e,tp,eg,ep,ev,re,r,rp)
