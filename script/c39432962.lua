...
function c39432962.initial_effect(c)
	...
	e1:SetTarget(c39432962.sumtg)
	e1:SetOperation(c39432962.sumop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
...
function c39432962.filter(c,e,tp)
	return c:IsSetCard(0x82) and not c:IsCode(39432962) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c39432962.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c39432962.filter,tp,LOCATION_HAND,0,1,nil,e,tp) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_HAND)
end
function c39432962.sumop(e,tp,eg,ep,ev,re,r,rp)
