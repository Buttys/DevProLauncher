...
function c1426714.atkfilter(c)
	return c:IsFaceup() and c:GetCode()==1426715
end
function c1426714.atkval(e,c)
	return Duel.GetMatchingGroupCount(c1426714.atkfilter,c:GetControler(),LOCATION_ONFIELD,0,nil)*500
end
