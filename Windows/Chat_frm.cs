            ...
            switch(cmd)
            {
                ...
                case "help":
                    ...
                    if (Program.UserInfo.rank > 1)
                    {
                        ...
                        WriteMessage(new ChatMessage(MessageType.System, CommandType.None, null, "/msg - Sends a server message"));
                        WriteMessage(new ChatMessage(MessageType.System, CommandType.None, null, "/mute username- Prevents a user from sending any messages"));
                        ...
                        WriteMessage(new ChatMessage(MessageType.System, CommandType.None, null, "/unmute username- Allows a muted user to message again"));
