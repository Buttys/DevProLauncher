...
namespace DevProLauncher.Windows
{
    public sealed partial class SupportFrm : Form
    {
        ...
        public void ApplyTranslation()
        {
            ...
            AddItem(Properties.Resources.swords, lang.SupportItem8Name, FormatString(lang.SupportItem8Des), 300, "NULL", false);
        ...
        private void Getitem(object handler, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Process.Start("http://ygopro.de/webbackend/login.php?sites=login");
                    return;
                }
